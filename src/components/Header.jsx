  ...
  return (
    <>
      <div className="flex justify-between py-2 px-4 items-center">
        <div className="flex w-full justify-between py-4 px-4 items-center mx-auto bg-black container  max-md:hidden">
          <div className="">
            <NavLink to="/">
          ...
          <div className="navlink flex">
            ...
            className="group text-white mx-4 my-2 ">
              Contact
