        ...
        <div className="px-4 flex relative flex-col items-start md:flex-row py-12 md:py-20 w-full">
          <div className="w-full sticky top-0  md:w-1/2">
            <motion.img
              ...
              className="h-auto"
            />
            <div className="py-10 relative overflow-hidden max-md:py-7">
              <motion.p
                initial={{
                  y: 50,
                  opacity: 0,
                ...
                viewport={{ once: true }}
                transition={{ duration: 1, ease: "backInOut" }}
                className="font-semibold absolute top-0 text-4xl md:text-6xl lg:text-7xl tracking-wide leading-tight"
              >
                BRAND
              </motion.p>
            </div>
          ...
          <div className="w-full md:w-1/2 h-auto py-3 relative md:my-4">
            ...
            <div className="card1 bg-gray-100 p-6 md:p-10 sticky top-1 ">
              <div className="flex items-center py-4 ">
                <motion.img
                  initial={{
                    opacity: 0,
                ...
                />
                <p className="font-medium text-xl md:text-4xl px-2">
                  BRAND DESIGN
                </p>
              </div>
              <p className="font-light text-sm md:text-base lg:text-xl leading-6 md:leading-8 tracking-wide text-gray-700">
            ...
            <div className="card2 bg-gray-100 p-6 md:p-10 sticky top-1 leading-8  mt-6">
              <div className="flex items-center py-4 ">
                <motion.img
                  initial={{
                    opacity: 0,
            ...
            <div className="card3 bg-gray-100 p-6 md:p-10 sticky -top-10 leading-8  mt-6">
              <div className="flex items-center py-4 ">
                <motion.img
                  initial={{
                    opacity: 0,
